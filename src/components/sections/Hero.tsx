    ...
    <div ref={scrollContainerRef} className="relative">
      ...
      <div className="fixed right-2 top-1/2 -translate-y-1/2 z-40 hidden lg:flex flex-col items-center gap-2 bg-black/30 backdrop-blur-sm py-2 px-1 rounded-full border border-white/5">
        {['overview', 'specs', 'design', 'story', 'services', 'reviews', 'contact'].map((id) => (
          <a
            ...
            title={`Scroll to ${id}`}
          >
            <span className="absolute right-5 opacity-0 group-hover:opacity-100 text-[10px] text-amber-400/90 uppercase font-bold tracking-[0.12em] transition-all duration-300 pointer-events-none select-none bg-black/90 px-1.5 py-0.5 rounded border border-amber-500/10 whitespace-nowrap">
              {id}
            </span>
      ...
      <section id="hero" className="relative min-h-screen flex flex-col items-center justify-center px-6 sm:px-12 pt-32 pb-16 snap-start snap-always overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
            ...
            <a
              ...
              className="inline-flex items-center gap-2.5 px-9 py-4 rounded-full bg-green-700/90 hover:bg-green-600 backdrop-blur-md text-white font-bold text-sm hover:-translate-y-0.5 transition-all duration-300 shadow-xl shadow-green-500/10 hover:shadow-green-500/25 active:translate-y-0"
            >
        ...
        <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-amber-500/60 pointer-events-none">
          <span className="text-[11px] tracking-[0.4em] uppercase font-bold">{t('hero_scroll')}</span>
      ...
      <section id="overview" className="scroll-section relative min-h-screen flex items-center px-6 sm:px-12 snap-start snap-always">
        <div className="absolute top-24 right-6 sm:right-12 text-right space-y-1">
          <p className="text-[11px] tracking-[0.2em] text-muted-foreground uppercase">Authorized Service Center</p>
          <p className="text-[11px] tracking-[0.2em] text-muted-foreground uppercase">Since 2019</p>
        </div>
        ...
        >
          <div className="glass-premium glass-premium-hover rounded-2xl p-6 sm:p-8 hover:-translate-y-1 transition-all duration-500 depth-3 relative overflow-hidden group">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-[11px] text-amber-400 uppercase tracking-[0.3em] font-bold">{t('card_expertise')}</span>
            </div>
        ...
        >
          <div className="glass-premium glass-premium-hover rounded-2xl p-6 sm:p-8 hover:-translate-y-1 transition-all duration-500 depth-3 relative overflow-hidden group">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-[11px] text-amber-400 uppercase tracking-[0.3em] font-bold">{t('card_quality')}</span>
            </div>
        ...
        >
          <div className="glass-premium glass-premium-hover rounded-2xl p-6 sm:p-8 hover:-translate-y-1 transition-all duration-500 depth-3 relative overflow-hidden group">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-[11px] text-amber-400 uppercase tracking-[0.3em] font-bold">{t('card_fullService')}</span>
            </div>
