...
import {
  Search, Plus, ChevronDown, ChevronRight, AlertCircle, Pencil, HelpCircle,
} from 'lucide-react';
...
export default function AccountsPage() {
  ...
  return (
    <div className="min-h-screen p-6 sm:p-8">
      ...
      <Modal isOpen={showModal} onClose={() => setShowModal(false)} title={editingAccount ? t('acct_edit') : t('acct_add')}>
      ...
      <Modal isOpen={showHelp} onClose={() => setShowHelp(false)} title={t('acct_help_title') || 'Chart of Accounts Guide'}>
